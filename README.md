...
The next several sections were taken directly from the project description. Source code files and figures have been uploaded to the git repository. Scroll down to the last section of this README to see the answers to the questions posed in the assignment.
...
# Review criteria
For each question: Does the plot appear to address the question being asked?
